...
import moment from "moment";
import axios from "axios";
import { MaterialIcons } from "@expo/vector-icons"; // Web-friendly icon
import { DataTable } from "react-native-paper";
...
const styles = StyleSheet.create({
  ...
  backButtonText: {
    marginLeft: 5,
    fontSize: 18,
    color: "#7F7FD5", // Purple color for the back button text
  },
  datePickerContainer: {
    flexDirection: "row",
    alignItems: "center",
  ...
  attendanceTableContainer: {
    backgroundColor: "#A1FFCE", // Light green background for the table
    borderRadius: 5,
    padding: 5,
  },
});
